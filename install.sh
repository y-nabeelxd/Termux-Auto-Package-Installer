...
packages=("git" "python" "python2" "curl" "perl" "ruby" "php" "bash" "clang" "nano" "zip" "unzip" "wget" "openssl" "openssh" "sl" "zsh" "nodejs" "ffmpeg" "w3m" "htop" "screen" "ripgrep" "fd" "fzf" "bat" "tealdeer" "fortune" "cowsay" "neofetch" "tmux" "jq" "yt-dlp" "termux-api" "rsync" "mpv" "pulseaudio" "imagemagick" "figlet" "lolcat" "cmatrix" "pv" "ncurses-utils" "tree" "lynx" "exa" "ranger")
